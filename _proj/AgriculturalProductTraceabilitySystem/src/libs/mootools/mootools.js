(function() {
	...
	/*document.onselectstart = function(event) {
		...
		//add 20160412  在地图容器中，infowindow-title下的文字要可以被选中
		if (target.nodeType == 3) {
			var parentEle = target.parentNode && target.parentNode.parentNode;
			if(parentEle && parentEle.nodeType == 1 && parentEle.className == "infowindow-title"){
				return true;
			}
		}
		//end 
		...
		if (target.tagName===undefined) {return;}
		var srcTagName = target.tagName.toLowerCase();
