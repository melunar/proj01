...
function renderHomepage3Demo(e) {
    ...
    function l() {
        function l(e, o, t) {
            e.on("updateAxisPointer", function(e) {
                o.dispatchAction(o.makeActionFromEvent(e), !0)
            }),
            e.on("dataZoom", function(e) {
                var t = e.batch ? e.batch[0] : e;
                o.dispatchAction({
                    type: "dataZoom",
                    dataZoomIndex: 0,
                    start: t.start,
            ...
            e.on("brush", function(e) {
                e.areas[0] && o.dispatchAction({
                    type: "brush",
                    areas: [{
                        xAxisIndex: 0,
                        brushType: "lineX",
                        coordRange: e.areas[0].coordRange
                    }]
                }, !0)
            })
        }
        var s = {
            ...
            tooltip: {
                ...
                formatter: function(o) {
                    var t = o[0].dataIndex;
                    return e.util.map([["seriesA", d, A], ["seriesB", d, I], ["seriesC", S, C]], function(o, n) {
                        return e.format.getTooltipMarker(o[1], n ? "" : "border-radius: 0;") + '<span style="color:' + e.format.encodeHTML(o[1]) + '">' + o[0] + ": " + o[2][t] + (n ? " m" : "") + "</span>"
                    }).join("<br>")
                }
            },
            axisPointer: {
          ...
          , h = {
            ...
            tooltip: {
                ...
                formatter: function(o) {
                    var t = o[0].dataIndex;
                    return e.util.map([["seriesA", d, A], ["seriesB", d, I], ["seriesC", S, C]], function(o, n) {
                        return e.format.getTooltipMarker(o[1], n ? "" : "border-radius: 0;") + '<span style="display:inline-block;width: 50px;color:' + e.format.encodeHTML(o[1]) + '">' + o[2][t] + (n ? " m" : "") + "</span>"
                    }).join("&nbsp;&nbsp;&nbsp;")
                }
            },
            axisPointer: {
